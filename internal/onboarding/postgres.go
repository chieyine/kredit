...
func (s *PostgresStore) Ensure(org, actor string, email, phone bool) (Profile, error) {
	...
	_, err = tx.Exec(context.Background(), `
		...
		SELECT pg_catalog.gen_random_uuid(),organization_id,version,'profile.created',$4,$5,to_jsonb(inserted)
...
func (s *PostgresStore) RecordKYBDecisionForReference(o, a, ref string, version int64, st, reason string, e time.Time) (Profile, Summary, error) {
	return s.apply(o, a, "kyb.decision", func(m *Store) (Profile, Summary, error) {
		return m.RecordKYBDecisionForReference(o, a, ref, version, st, reason, e)
	})
}
