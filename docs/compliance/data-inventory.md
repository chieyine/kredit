...
## Personal purchases (September 2026)

Consumer sale offers retain the exact invited contact, immutable item/payment/delivery terms and the retailer's approved bank instructions. Acceptance retains the customer's name, delivery address and adult/terms declaration. Immutable purchase events retain payment/return/refund evidence and action times. These records are restricted financial/personal data under retailer-role, exact-customer and super-admin policies, with financial retention holds. Consumer bank instructions are matched to the original provider registration; restrictions are owner-controlled; full account numbers are receiving instructions, not bank access credentials. Personal exports include consumer offers/agreements and the customer's purchase history. Consumer information is not used to allocate receipts to a wholesaler debt.

DSA profiles retain agent contact and payout details; referral records retain owner-confirmed attribution and frozen reward terms. Signed reward entries and completed payout evidence are financial history. Agents can read only their own records and referral progress; Super Admin manages exceptions and payout evidence. Personal exports include the agent's records.
