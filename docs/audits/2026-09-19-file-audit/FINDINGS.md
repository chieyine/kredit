...
Files: [internal/ledger/postgres.go:143–148,201](../../../internal/ledger/postgres.go#L143); [internal/ledger/store.go:177–184](../../../internal/ledger/store.go#L177); [db/migrations/004_milestone3_credit_ledger.sql:16](../../../db/migrations/004_milestone3_credit_ledger.sql#L16).
...
Files: [internal/web/auth_handlers.go:100–112](../../../internal/web/auth_handlers.go#L100); [internal/auth/postgres.go](../../../internal/auth/postgres.go) (`SessionFromToken`, `RevokeSession`); [web/src/lib/api/client.ts:70–78](../../../web/src/lib/api/client.ts#L70).
...
File: [cmd/backup-r2/main.go:200–206](../../../cmd/backup-r2/main.go#L200).
...
File: [cmd/backup-r2/main.go:126–129,200–210](../../../cmd/backup-r2/main.go#L126).
...
File: [web/src/routes/buyer/bank-authorization/[reference]/+page.svelte:31](<web/src/routes/buyer/bank-authorization/[reference]/+page.svelte:31>).
...
Files: [internal/providers/bankdebit/recovery.go](../../../internal/providers/bankdebit/recovery.go) (`Pending`); [internal/web/mandate_recovery_handlers.go](../../../internal/web/mandate_recovery_handlers.go) (`listMandateAuthorizations`); [internal/access/roles.go](../../../internal/access/roles.go); [db/migrations/154_bank_debit_enrollment.sql:16–17](../../../db/migrations/154_bank_debit_enrollment.sql#L16).
...
Files: [internal/consumer/store.go](../../../internal/consumer/store.go) (`Create`, `Get`, `List`); [internal/access/roles.go](../../../internal/access/roles.go) (`Can`); [internal/web/consumer_handlers.go](../../../internal/web/consumer_handlers.go).
...
Files: [web/src/lib/consumer.ts](../../../web/src/lib/consumer.ts) (`Mutation.send`); [web/src/lib/components/ConsumerSales.svelte](../../../web/src/lib/components/ConsumerSales.svelte) (`create`, `retry`); [internal/web/server.go](../../../internal/web/server.go) (`withIdempotency`); [internal/consumer/store.go](../../../internal/consumer/store.go) (`Create`).
...
Files: [internal/reports/analytics.go:111](../../../internal/reports/analytics.go#L111), [internal/reports/analytics.go:148](../../../internal/reports/analytics.go#L148); [db/migrations/122_scorecard_projections.sql:60](../../../db/migrations/122_scorecard_projections.sql#L60); [internal/reports/payment_metrics.go:5](../../../internal/reports/payment_metrics.go#L5).
...
Files: [db/migrations/122_scorecard_projections.sql:58](../../../db/migrations/122_scorecard_projections.sql#L58); [internal/reports/analytics.go:138](../../../internal/reports/analytics.go#L138); [db/migrations/112_system_acceptance_evidence.sql](../../../db/migrations/112_system_acceptance_evidence.sql); [internal/credit/postgres.go:484](../../../internal/credit/postgres.go#L484).
...
Files: [internal/reports/store.go](../../../internal/reports/store.go) (`TrackContext`); [internal/web/reports_handlers.go](../../../internal/web/reports_handlers.go) (`trackOptionalActivity` and report handlers); [db/migrations/050_product_analytics.sql:17](../../../db/migrations/050_product_analytics.sql#L17).
...
Files: [infra/environments/main.tf](../../../infra/environments/main.tf) (web container environment); [web/src/lib/server/legal-config.ts:11](../../../web/src/lib/server/legal-config.ts#L11); [web/src/hooks.server.ts:6](../../../web/src/hooks.server.ts#L6).
...
Files: [internal/web/feedback_handlers.go:20–28](../../../internal/web/feedback_handlers.go#L20); [internal/feedback/store.go:53–95](../../../internal/feedback/store.go#L53); [db/migrations/050_product_analytics.sql:30–63](../../../db/migrations/050_product_analytics.sql#L30); [internal/reports/analytics.go:93](../../../internal/reports/analytics.go#L93).
...
Files: [internal/credit/reads.go:10–12,38–62](../../../internal/credit/reads.go#L10); [internal/web/financial_reads.go:15–20](../../../internal/web/financial_reads.go#L15); [internal/web/credit_handlers.go:183–197](../../../internal/web/credit_handlers.go#L183); [internal/credit/store.go:991–993,1031–1033](../../../internal/credit/store.go#L991).
...
Files: [internal/credit/postgres.go:885–888](../../../internal/credit/postgres.go#L885); [internal/credit/store.go:749–750,796–798](../../../internal/credit/store.go#L749); [internal/web/credit_handlers.go:494–510](../../../internal/web/credit_handlers.go#L494); [web/src/routes/buyer/credit-requests/[requestID]/+page.svelte:68](<web/src/routes/buyer/credit-requests/[requestID]/+page.svelte:68>).
...
Files: [internal/mandates/provider.go:268–273,387–406](../../../internal/mandates/provider.go#L268); [internal/web/mandate_handlers.go:32–43](../../../internal/web/mandate_handlers.go#L32); [internal/web/runtime.go:862–876](../../../internal/web/runtime.go#L862).
...
Files: web/src/routes/app/credit/new/+page.svelte:17,103,149 (`web/src/routes/app/credit/new/+page.svelte:17`, since removed); [internal/credit/store.go:1131–1144](../../../internal/credit/store.go#L1131); [internal/credit/postgres.go:502–527](../../../internal/credit/postgres.go#L502); [internal/schedules/store.go:211–222,589–594](../../../internal/schedules/store.go#L211); [internal/web/credit_terms_handlers.go:25–50](../../../internal/web/credit_terms_handlers.go#L25).
...
Files: [internal/tradelines/store.go:521–524,768–780](../../../internal/tradelines/store.go#L521); [internal/tradelines/postgres.go:222](../../../internal/tradelines/postgres.go#L222); [internal/web/credit_handlers.go:1083–1086](../../../internal/web/credit_handlers.go#L1083).
...
Files: [internal/tradelines/store.go:515–519,540–548,610–619,781–805](../../../internal/tradelines/store.go#L515); [internal/tradelines/postgres.go:445](../../../internal/tradelines/postgres.go#L445); [db/migrations/046_trade_line_drawdown_lifecycle.sql:86–97](../../../db/migrations/046_trade_line_drawdown_lifecycle.sql#L86); [internal/jobs/client.go:306–314](../../../internal/jobs/client.go#L306).
...
Files: web/src/routes/buyer/+page.svelte:24,41,65–70 (`web/src/routes/buyer/+page.svelte:24`, since removed); [web/src/lib/money.ts:20–24](../../../web/src/lib/money.ts#L20); [internal/credit/reads.go:38,60–63](../../../internal/credit/reads.go#L38); [internal/credit/store.go:649–665,689–705,1040–1054](../../../internal/credit/store.go#L649).
...
Files: [web/src/routes/buyer/credit-requests/[requestID]/+page.svelte:83–86,144](<web/src/routes/buyer/credit-requests/[requestID]/+page.svelte:83>); [web/src/lib/api/mutation.ts:21,36,45](../../../web/src/lib/api/mutation.ts#L21); [internal/paymentclaims/store.go:117–125,217–218](../../../internal/paymentclaims/store.go#L117); `web/src/routes/app/payments/+page.svelte:83`; [web/src/routes/app/credit/[id]/+page.svelte:114–120,184](<web/src/routes/app/credit/[id]/+page.svelte:114>).
...
Files: web/src/routes/app/settings/credit-policy/+page.svelte:8–12 (`web/src/routes/app/settings/credit-policy/+page.svelte:8`, since removed); web/src/routes/app/credit/quick/+page.svelte:59–63,77,84–102,126 (`web/src/routes/app/credit/quick/+page.svelte:59`, since removed); web/src/routes/app/credit/new/+page.svelte:16,46–47,60–79,103 (`web/src/routes/app/credit/new/+page.svelte:16`, since removed); [internal/onboarding/store.go:337](../../../internal/onboarding/store.go#L337).
