...
test('inbox records ownership and history exposes previous and proposed values',async({page,context,baseURL})=>{
 ...
 await page.route('**/api/v1/ops/approval-inbox?*',r=>r.fulfill({json:{actor_id:'checker',items:[{id:'review',kind:'policy',title:'Update fees',state:'pending',author:'Policy Manager',owner,due_at:'2027-01-01T10:00:00Z',href:'/admin/settings'}]}}));
