<script lang="ts">
	...
	const stages = [
		{ role: 'Seller', title: 'Write the sale down', action: 'Send it to my customer' },
		{ role: 'Customer', title: 'Read it properly', action: 'Yes, I agree to this' },
		{ role: 'Customer', title: 'Give the bank permission', action: 'Complete sample bank permission' },
		{ role: 'Seller', title: 'Send the goods out', action: 'The goods have gone out' },
		{ role: 'Customer', title: 'Confirm what arrived', action: 'Yes, I received them' },
