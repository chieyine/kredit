...
<main class="shell workspace account-home">
  ...
  <p><a class="referral-link" href="/app/referral">{referralPending?'Finish confirming your field agent introduction before your first sale →':'Introduced by a field agent? Confirm their referral here →'}</a></p>
