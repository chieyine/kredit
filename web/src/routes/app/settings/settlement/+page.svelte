...
<main class="shell workspace form-page"><p class="eyebrow">Settings / Bank account</p><h1>Where should your payments go?</h1><p>Choose your bank and enter the account number where you want to receive payments. If your business has no CAC registration, use an account in the verified owner’s full name.</p>
