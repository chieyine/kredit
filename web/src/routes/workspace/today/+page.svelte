...
<main class="shell workspace account-home">
  ...
  {:else if currentBusiness}
    ...
    <nav aria-label="Grow your customer network"><a href="/workspace/partners/invitations{scopeQuery}">Distributor onboarding</a> · <a href="/workspace/partners/import{scopeQuery}">Import distributors</a> · <a href="/workspace/partners/customers/new{scopeQuery}">Invite a customer</a></nav>
