...
<main class="shell workspace">
	...
	{#if data}
		...
		<p><a href={workspaceHref('/workspace/purchases/amendments',page.url)}>See any changes to your payment days, and what you agreed to →</a></p>
     ...
     {@const debitNotice=data.collection_notices.find((n:any)=>n.schedule_item_id===item.id)}
		...
		<a href={`/workspace/purchases/orders/${encodeURIComponent(data.view.request.id)}`}>Pay this sale, or report a problem →</a>
