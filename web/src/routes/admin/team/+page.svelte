...
<style>
	.team>header{padding:2rem 0;border-bottom:3px solid var(--color-primary)}.team h1{margin:.4rem 0;font-family:var(--font-serif);font-size:clamp(2.5rem,6vw,4.5rem);font-weight:500;line-height:.95}.team header p{max-width:44rem}.columns{display:grid;grid-template-columns:1.4fr .8fr;gap:2rem;margin-top:2rem}.columns>section{min-width:0}.columns h2{font-family:var(--font-serif);font-size:1.8rem;font-weight:500}article{display:grid;grid-template-columns:1fr auto auto;align-items:center;gap:1rem;padding:1rem 0;border-bottom:1px solid var(--color-border)}article strong,article span,article b,article small{display:block}article span,article small{margin-top:.25rem;color:var(--color-foreground);font-size:.72rem}article b{text-transform:capitalize}article button{padding:.55rem;border:1px solid var(--color-overdue);background:transparent;color:var(--color-overdue);font:inherit;font-size:.74rem;font-weight:800}.grant{padding:1.2rem;background:var(--color-primary);color:var(--color-on-primary)}.grant form,.grant label,.revoke,.revoke label{display:grid;gap:.7rem}.grant label,.revoke label{gap:.3rem;font-size:.76rem;font-weight:750}	.grant input,.grant select,.grant textarea,.grant button,.revoke textarea,.revoke button{box-sizing:border-box;width:100%;padding:.7rem;border:1px solid var(--color-border-strong);background:var(--color-foreground);color:var(--color-on-primary);font:inherit}.user-search{grid-template-columns:1fr auto;align-items:end}.user-search button{width:auto;white-space:nowrap}.results{display:grid;margin:.6rem 0;border:1px solid var(--color-border-strong)}.results button{display:grid;gap:.2rem;text-align:left;border-width:0 0 1px}.results button:last-child{border-bottom:0}.results span,.selected span,.selected small,.hint{color:var(--color-muted);font-size:.74rem}.selected{display:grid;gap:.2rem;padding:.75rem;border-left:3px solid var(--color-accent);background:var(--color-surface-muted)}.selected strong{font-size:1.05rem}.grant-form{margin-top:1rem}.grant .primary{background:var(--color-accent);color:var(--color-on-primary);font-weight:850}.revoke{margin-top:1rem;padding:1rem;border:2px solid var(--color-overdue);background:var(--color-background)}.revoke h3,.revoke p{margin:0}.revoke textarea{background:var(--color-surface);color:var(--color-primary);border-color:var(--color-border)}.revoke>div{display:flex;gap:.5rem}.revoke button{background:var(--color-surface);color:var(--color-primary);border-color:var(--color-primary)}.revoke .danger{background:var(--color-overdue);color:var(--color-on-primary);border-color:var(--color-overdue)}@media(max-width:800px){.columns{grid-template-columns:1fr}}@media(max-width:540px){article{grid-template-columns:1fr}article button{justify-self:start}.user-search{grid-template-columns:1fr}.user-search button{width:100%}}
</style>
