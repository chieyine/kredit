...
<style>
 .editor{max-width:72rem;margin:auto;padding:3rem 1.5rem;color:var(--color-foreground)}header{max-width:48rem}h1{font-size:clamp(2.2rem,5vw,4rem);line-height:1.05;margin:.5rem 0 1rem}h2{font-size:1.8rem}p{line-height:1.65}label{display:grid;gap:.5rem;font-weight:600;margin:1rem 0}input,textarea,select{box-sizing:border-box;max-width:100%;width:100%;padding:.8rem;border:1px solid var(--color-border-strong);border-radius:.25rem;background:var(--color-surface);font:inherit;color:inherit}textarea{resize:vertical}button{padding:.8rem 1rem;border:1px solid var(--color-border-strong);border-radius:.25rem;background:var(--color-surface);color:var(--color-foreground);font:inherit;cursor:pointer}button:disabled{opacity:.55;cursor:not-allowed}button:focus-visible,input:focus-visible,textarea:focus-visible,select:focus-visible{outline:3px solid var(--color-primary);outline-offset:3px}.toolbar,.actions{display:flex;align-items:center;gap:1rem;flex-wrap:wrap}.toolbar label{min-width:16rem}.version,.hint{font-size:.9rem}fieldset{padding:0;border:0}.question{border-top:1px solid var(--color-border);margin:2rem 0;padding-top:1rem}.notice{padding:1rem;border-left:3px solid var(--color-primary);background:var(--color-surface)}.error{border-color:var(--color-overdue)}.preview{margin-top:2rem;padding:clamp(1.2rem,4vw,3rem);background:var(--color-surface);border:1px solid var(--color-border);overflow-wrap:anywhere}.preview p{white-space:pre-wrap;max-width:68ch}.preview h2{font-size:clamp(2rem,4vw,3rem)}.publish,.actions button:first-child{background:var(--color-primary);color:var(--color-on-primary);border-color:var(--color-primary)}.history{border-top:1px solid var(--color-border);margin-top:3rem;padding-top:2rem}.history article{display:flex;gap:1rem;justify-content:space-between;align-items:center;border-bottom:1px solid var(--color-border);padding:1rem 0}.history article p{margin:.3rem 0}@media(max-width:600px){.editor{padding:2rem 1rem}.history article{align-items:flex-start;flex-direction:column}.toolbar>*{width:100%}}
</style>
