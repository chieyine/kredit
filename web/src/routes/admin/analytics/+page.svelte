...
<style>
	.analytics{padding-bottom:4rem}.analytics>h1{max-width:12ch;font-family:var(--font-serif);font-size:clamp(3rem,7vw,5.5rem);font-weight:500;line-height:.92;letter-spacing:-.055em}.analytics form{display:grid;grid-template-columns:repeat(auto-fit,minmax(11rem,1fr));gap:1rem;align-items:end;margin:2rem 0;padding:1rem;border:1px solid var(--color-border);border-radius:0}.analytics label{display:grid;gap:.4rem;font-weight:700}.analytics input,.analytics button{min-height:2.75rem;border:1px solid var(--color-border);border-radius:0;padding:.6rem}.analytics button{background:var(--color-primary);color:var(--color-on-primary);font-weight:800;--color-muted:rgb(255 255 255 / .72);}.status{display:flex;justify-content:space-between;gap:1rem;flex-wrap:wrap;padding:1rem;border-left:.35rem solid var(--color-warning);background:var(--color-background)}.status.healthy{border-color:var(--color-positive);background:var(--color-background)}.status span{color:var(--color-muted)}.application-snapshot{margin:1.5rem 0;border:3px solid var(--color-primary);background:var(--color-surface);box-shadow:10px 10px 0 var(--color-border)}.application-snapshot>header{display:flex;align-items:end;justify-content:space-between;gap:1rem;padding:1.5rem;border-bottom:3px solid var(--color-primary)}.application-snapshot h2{max-width:22ch;margin:.25rem 0;font-family:var(--font-serif);font-size:clamp(1.8rem,4vw,3rem);font-weight:500}.proof-grid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr))}.proof-grid article{display:grid;gap:.5rem;padding:1.25rem;border-right:1px solid var(--color-border);border-bottom:1px solid var(--color-border)}.proof-grid span{font-weight:750}.proof-grid strong{font-family:var(--font-serif);font-size:clamp(1.6rem,3vw,2.4rem);font-weight:500;color:var(--color-primary)}.proof-grid small{color:var(--color-muted)}.evidence-note{margin:0;padding:1.25rem;background:var(--color-background)}.feedback-breakdown{display:grid;grid-template-columns:1.5fr 1fr;gap:2rem;margin:3rem 0;padding:clamp(1.5rem,4vw,2.5rem);color:var(--color-on-primary);background:var(--color-primary);--color-muted:rgb(255 255 255 / .72);}.feedback-breakdown h2{font-family:var(--font-serif);font-size:2.25rem;font-weight:500}.feedback-breakdown p{color:var(--color-muted)}.feedback-breakdown dl{display:grid;grid-template-columns:repeat(3,1fr);margin:0}.feedback-breakdown dl div{display:grid;align-content:center;padding:1rem;border:1px solid var(--color-border-strong);text-align:center}.feedback-breakdown dt{color:var(--color-muted)}.feedback-breakdown dd{margin:.35rem 0;font-family:var(--font-serif);font-size:2.4rem}.full-scorecard{margin-top:2rem;border-top:3px solid var(--color-primary)}.full-scorecard summary{padding:1.2rem 0;font-size:1.1rem;font-weight:800;cursor:pointer}.metrics{display:grid;grid-template-columns:repeat(auto-fit,minmax(15rem,1fr));gap:1rem;margin-bottom:2rem}.metrics article{border:1px solid var(--color-border);border-radius:0;padding:1.15rem;background:var(--color-surface)}.metrics article>strong{font-size:1.55rem;color:var(--color-primary)}.metrics h3{margin:.45rem 0}.metrics p{min-height:3.8rem}.metrics small{color:var(--color-muted)}.table-wrap{overflow-x:auto}table{border-collapse:collapse;width:100%;background:var(--color-surface)}caption{text-align:left;padding:.75rem 0}th,td{text-align:left;padding:.75rem;border-bottom:1px solid var(--color-border)}td span{color:var(--color-overdue);font-weight:800}.ok{color:var(--color-positive)}@media(max-width:48rem){.proof-grid{grid-template-columns:1fr 1fr}.feedback-breakdown{grid-template-columns:1fr}.application-snapshot>header{align-items:start;flex-direction:column}}@media(max-width:40rem){.proof-grid{grid-template-columns:1fr}.metrics p{min-height:0}}@media print{.analytics>form,.analytics>.status,.application-snapshot button,.feedback-breakdown,.full-scorecard{display:none}.application-snapshot{box-shadow:none}.analytics{padding:0}.application-snapshot{margin:0}}
</style>
