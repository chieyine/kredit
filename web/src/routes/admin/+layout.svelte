<script lang="ts">
	...
	const links: [string,string][] = [['Overview','/admin'],['Approval queue','/admin/inbox'],['Financial approvals','/admin/approvals'],['Change history','/admin/history'],['Needs attention','/admin/attention'],['Users','/admin/users'],['Businesses','/admin/organizations'],['Money movement','/admin/money'],['Support cases','/admin/cases'],['Disputes','/admin/disputes'],['Analytics evidence','/admin/analytics'],['Find a reference','/admin/search'],['Background jobs','/admin/jobs'],['Provider events','/admin/provider-events'],['Reconciliation reviews','/admin/reconciliation'],['System diagnostics','/admin/diagnostics'],['Mono integration','/admin/mono'],['Account recovery','/admin/recovery'],['Privacy requests','/admin/privacy'],['Platform settings','/admin/platform-settings'],['Business settings','/admin/settings'],['Protected controls','/admin/controls'],['Admin access','/admin/team'],['Audit trail','/admin/audit']];
	...
	const mobileMore:[string,string,string][]=[
		...
		['Analytics evidence','/admin/analytics','Operations'],['Find a reference','/admin/search','Operations'],['Background jobs','/admin/jobs','Operations'],['Provider events','/admin/provider-events','Operations'],['Reconciliation reviews','/admin/reconciliation','Operations'],['System diagnostics','/admin/diagnostics','Operations'],['Mono integration','/admin/mono','Operations'],
		['Platform settings','/admin/platform-settings','Access and control'],['Business settings','/admin/settings','Access and control'],['Protected controls','/admin/controls','Access and control'],['Admin access','/admin/team','Access and control'],['Audit trail','/admin/audit','Access and control']
	];
</script>
