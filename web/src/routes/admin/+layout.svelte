<script lang="ts">
	...
	const mobileMore:[string,string,string][]=[
		...
		['Analytics evidence','/admin/analytics','Operations'],['Find a reference','/admin/search','Operations'],['Background jobs','/admin/jobs','Operations'],['Provider events','/admin/provider-events','Operations'],['Reconciliation reviews','/admin/reconciliation','Operations'],['System diagnostics','/admin/diagnostics','Operations'],
		['Business settings','/admin/settings','Access and control'],['Protected controls','/admin/controls','Access and control'],['Admin access','/admin/team','Access and control'],['Audit trail','/admin/audit','Access and control']
	];
</script>
