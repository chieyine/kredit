...
<style>
 main{max-width:1100px;margin:auto;padding:2rem 1rem}fieldset,article{border:1px solid var(--color-border,var(--color-border));border-radius:1rem;padding:1.25rem;margin:1.5rem 0}legend,h3{font-weight:700}label{display:block;font-weight:600;margin:.8rem 0 .35rem}input,select,textarea{width:100%;max-width:36rem;padding:.7rem;border:1px solid var(--color-border);border-radius:.4rem;background:var(--color-surface);color:var(--color-foreground)}textarea{display:block;min-height:5rem}small{display:block;max-width:48rem;margin:.4rem 0;color:var(--color-foreground)}.setting{padding:.5rem 0;border-bottom:1px solid var(--color-border)}.current,.history{font-size:.9rem;color:var(--color-foreground)}.notice{padding:1rem;background:var(--color-surface-muted);border-radius:.5rem}button{padding:.7rem 1rem;margin:.7rem .5rem .4rem 0;border:1px solid var(--color-border);border-radius:.5rem}button:disabled{opacity:.55}.table-wrap{overflow:auto}table{border-collapse:collapse;width:100%;margin:1rem 0}th,td{text-align:left;padding:.7rem;border-bottom:1px solid var(--color-border)}.changed{background:var(--color-surface-muted)}.error{color:var(--color-overdue)}article p{overflow-wrap:anywhere}
</style>
