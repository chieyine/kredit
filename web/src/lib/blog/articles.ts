...
export const draftGuideSlugs = allGuideDrafts.filter((draft) => draft.draft === true).map((draft) => draft.slug);
...
export function articleForSlug(slug: string) {
...
export const articleCategoryDetails: Record<ArticleCategory, { slug: string; title: string; description: string }> = {
	'Credit sales': {
		slug: 'credit-sales',
		title: 'Credit sales guides',
		description:
			'Learn how to choose customers, set a safe limit and agree clear payment terms before goods leave your business.'
	},
	'Customer checks': {
		slug: 'customer-checks',
		title: 'Customer check guides',
		description:
			'Twelve questions to discuss with a customer before agreeing a credit order, from delivery details to the source of repayment.'
	},
	Agreements: {
		slug: 'agreements',
		title: 'Credit agreement guides',
		description:
			'Learn what to write down, how customers accept a sale and which delivery and payment records both sides should keep.'
	},
	Payments: {
		slug: 'payments',
		title: 'Customer payment guides',
		description:
			'Learn how to confirm transfers, record cash and part-payments, issue receipts and keep every customer balance correct.'
	},
	'Late payment': {
		slug: 'late-payment',
		title: 'Late payment guides',
		description:
			'Payment reminder examples for before the due date, on the day and after a missed payment, with room for the customer to respond.'
	},
	'Cash flow': {
		slug: 'cash-flow',
		title: 'Cash-flow guides',
		description:
			'Learn how unpaid sales affect stock and bills, and how to plan around the money customers still owe your business.'
	},
	'Business records': {
		slug: 'business-records',
		title: 'Business record guides',
		description:
			'Decide what belongs in a customer record, control staff access and prepare for a lost phone or a change in your team.'
	},
	'Safe payments': {
		slug: 'safe-payments',
		title: 'Safe payment guides',
		description:
			'Check incoming money in your own account and handle transfer screenshots, delayed payments and suspicious refund requests.'
	},
	'Industry guides': {
		slug: 'industry-guides',
		title: 'Credit guides for different businesses',
		description:
			'A building-material sale involves the buyer, the delivery site and whoever signs for the goods. Keep those responsibilities clear.'
	},
	'Business growth': {
		slug: 'business-growth',
		title: 'Business growth guides',
		description:
			'Write a credit policy your team can use: who approves an order, when supply pauses and how exceptions are recorded.'
	}
};
