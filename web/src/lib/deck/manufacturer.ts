...
export const manufacturerDeck: Slide[] = [
	...
	},
	{
		...
		points: [
			...
			[
				'Payment waits on goodwill',
				'Somebody has to call, then travel down, then call again. Usually the sales rep, who should be opening new accounts.'
			],
	...
	},
	{
		...
		points: [
			[
				'The credit decision stays yours',
				'Limits, terms, who qualifies. Kredit never fronts goods or cash, and never guarantees repayment.'
			],
			['One agreement, accepted by both parties', 'Sealed on acceptance, so it is not edited afterwards.'],
			[
				'Bank permission taken up front',
				'Collection runs on the due date against a mandate, instead of recovery after the account has gone bad.'
			]
		]
	},
	{
		...
		points: [
			...
			[
				'Deliver',
				'Dispatch and receipt are logged against that trade. Short delivery is reported there, not argued about three weeks later.'
			],
	...
	},
	{
		...
		source:
			'Bank authorisation runs through licensed providers. A debit already submitted to a bank may still complete.'
	},
	{
		kind: 'statement',
	...
	},
	{
		...
		points: [
			[
				...
				'On the value of the activated sale, with a minimum, capped at the sale amount.'
			],
	...
	},
	{
		...
		points: [
			...
			[
				'Widen it when you are satisfied',
				'Bring the others on after that first account has been through a full payment cycle.'
			]
		],
