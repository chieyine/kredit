...
export const investorDeck: Slide[] = [
  ...
  },
  {
    ...
    points: [
      ['The supplier already made the credit decision', 'He knows this customer, often for years. He does not need a score. He needs the agreement to hold.'],
      ['The missing piece is the instrument, not the money', 'An accepted record, a bank mandate taken before the goods move, and a trail that survives a dispute.'],
      ['That makes us infrastructure, not a balance sheet', 'We take no credit risk and hold no loan book. We charge for the rails.']
    ]
  },
  {
    kind: 'statement',
    ...
    points: [
      ['The usual pre-seed risk is already retired', 'Most rounds at this stage are funding the question of whether the team can build it. That question is answered. You can open it yourself.'],
      ['It is not quick to copy', 'Mandates, disputes, reversals and reconciliation are where this gets hard. A demo takes a weekend. None of this did.'],
      ['What you are not seeing yet', 'No volume, and no settled cycles behind us. We are at day one, and we are not going to dress that up.']
    ],
  ...
  },
  {
    ...
    points: [
      ['Connect', 'The supplier invites his customer, who joins with his own account and confirms the business he represents.'],
      ['Agree', 'Goods, price and dates go on record. The customer accepts, and gives the bank permission the trade requires.'],
  ...
  },
  {
    ...
    points: [
      ['A base fee when a sale goes live', 'Charged on the activated sale value, subject to a minimum and capped at the sale amount.'],
      ['A collection fee on money actually collected', 'A failed debit earns nothing. Our revenue tracks money that genuinely moves.'],
      ['No monthly fee, no joining fee', 'Nothing to negotiate at the top of the funnel, which matters when the buyer is a commercial director rather than a CTO.']
    ],
  ...
  },
  {
    ...
    points: [
      ['Land upstream', 'The manufacturer has the receivables pain, the leverage over his network, and the ability to make it a condition of credit.'],
      ['The network pulls itself down the chain', 'A distributor already using it to pay his supplier is one step from using it to get paid by his retailers.'],
  ...
  },
  {
    ...
    points: [
      ['Mandate reliability', 'Collection depends on bank debit succeeding at acceptable rates. A debit can fail, and we do not guarantee repayment. This is the core execution risk and we do not hide it.'],
      ['Manufacturer sales cycles are long', 'A commercial director at a listed company does not sign in a week. Our answer is one distributor, one cycle, rather than a network-wide decision.'],
      ['Regulatory movement', 'Direct debit and payment rails in Nigeria are actively regulated. We run mandates through licensed providers rather than holding the permission ourselves.']
    ]
  },
  {
    kind: 'cover',
