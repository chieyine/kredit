				...
				<div class="more-links" role="navigation" aria-label="Account menu pages" data-sveltekit-preload-data="tap">
					{#each menuGroups() as group}
						<section class="menu-group">
							<h2>{group.label}</h2>
							<div>{#each group.links as [linkLabel, href]}<a {href} aria-current={current(href) ? 'page' : undefined} onclick={() => closeMenus()}><span>{linkLabel}</span><span aria-hidden="true">→</span></a>{/each}</div>
						</section>
					{/each}
				</div>
...
<style>
  .signout-error{position:relative;z-index:58;margin:0;padding:1rem;background:var(--color-background);color:var(--color-warning);border-bottom:1px solid var(--color-warning);line-height:1.6}.signout-error p{margin:0 0 .5rem}.signout-error button{padding:.6rem 1rem;border:1px solid currentColor;background:transparent;color:inherit}.more-sheet:not([open]){display:none}.more-sheet{margin:0 0 0 auto;max-width:none;max-height:none;padding:0;color:var(--color-foreground)}.more-sheet::backdrop{background:rgb(23 24 27 / .48)}
	...
	nav {
		...
		background:#0b0d12;position:sticky;top:0;z-index:40;
	...
	.brand{display:inline-flex;align-items:center;gap:.65rem;color:var(--color-on-primary);font-family:var(--font-serif);font-weight:650;font-size:1.15rem;text-decoration:none;white-space:nowrap}.brand span{display:grid;place-items:center;width:2rem;height:2rem;background:var(--color-primary);color:var(--color-on-primary)}
	.account-label{display:none;color:var(--color-muted);font-size:.68rem;font-weight:800;letter-spacing:.12em;text-transform:uppercase}
	.portal-menu{display:flex;align-items:center;gap:.75rem;min-width:0;flex:1}.portal-links{display:flex;align-items:center;gap:.1rem;min-width:0;overflow-x:auto;scrollbar-width:none}.portal-links::-webkit-scrollbar{display:none}.portal-links a{position:relative;display:inline-flex;align-items:center;min-height:2.75rem;padding:.15rem .68rem;color:var(--color-muted);font-size:.84rem;font-weight:680;text-decoration:none;white-space:nowrap}.portal-links a:hover{color:var(--color-on-primary)}.portal-links a[aria-current='page']{color:var(--color-on-primary);background:transparent}
	.portal-links a[aria-current='page']::after{content:'';position:absolute;left:.68rem;right:.68rem;bottom:.3rem;height:1px;background:var(--color-primary)}
	.portal-actions{display:flex;align-items:center;gap:.35rem;margin-left:auto}.portal-actions button,.menu-toggle,.mobile-header-menu{border:0;background:transparent;color:var(--color-muted);font:inherit;font-size:.82rem;font-weight:680;cursor:pointer;white-space:nowrap}.portal-actions .search,.portal-actions .desktop-header-menu{display:inline-flex;align-items:center;gap:.4rem;padding:.45rem .7rem;border:1px solid var(--color-border-strong)}.portal-actions .desktop-header-menu.active{border-color:var(--color-primary);color:var(--color-on-primary)}.desktop-header-menu span{color:var(--color-overdue);font-size:1rem}.search kbd{font-family:inherit;font-size:.7rem;color:var(--color-muted)}.menu-toggle,.mobile-header-menu{display:none}.menu-toggle span,.mobile-header-menu span{font-size:1.2rem;color:var(--color-accent)}
	nav.dark{background:#0b0d12;border-color:rgb(255 255 255 / .07)}.dark .brand,.dark .portal-links a,.dark .portal-actions button{color:var(--color-on-primary)}.dark .portal-links a:hover,.dark .portal-links a[aria-current='page']{color:var(--color-on-primary);background:transparent}
	.portal-links a[aria-current='page']::after{content:'';position:absolute;left:.68rem;right:.68rem;bottom:.3rem;height:1px;background:var(--color-primary)}
	.desktop-primary{display:flex;align-items:center;gap:.1rem;min-width:0}.desktop-primary a{display:inline-flex;align-items:center;gap:.45rem;min-height:2.75rem;padding:.15rem .78rem;border:0;background:transparent;color:var(--color-muted);font:inherit;font-size:.84rem;font-weight:680;text-decoration:none;white-space:nowrap;cursor:pointer}.desktop-primary a:hover{color:var(--color-on-primary)}.desktop-primary a[aria-current='page']{position:relative;color:var(--color-on-primary);background:transparent}
	.desktop-primary a[aria-current='page']::after{content:'';position:absolute;left:.68rem;right:.68rem;bottom:.3rem;height:1px;background:var(--color-primary)}
	.mobile-nav{display:none}
	.more-sheet{position:fixed;z-index:61;top:3.65rem;right:0;bottom:0;display:block;width:min(26rem,calc(100vw - 2rem));overflow:hidden;border-left:1px solid var(--color-border);border-top:4px solid var(--color-primary);background:var(--color-surface);box-shadow:-24px 0 70px rgba(23,24,27,.2);animation:drawer-in .22s cubic-bezier(.22,.8,.28,1)}
	.more-sheet header{display:flex;align-items:center;justify-content:space-between;padding:1.05rem 1.25rem;border-bottom:1px solid var(--color-border)}.more-sheet header div{display:flex;flex-direction:column;gap:.14rem}.more-sheet header span{color:var(--color-primary);font-size:.68rem;font-weight:850;letter-spacing:.14em;text-transform:uppercase}.more-sheet header strong{font-family:var(--font-serif);font-size:1.45rem}.more-sheet header button{display:grid;place-items:center;width:2.75rem;height:2.75rem;border:1px solid var(--color-border);background:transparent;color:var(--color-primary);font-size:1.6rem;cursor:pointer}.sheet-content{max-height:calc(100vh - 8.8rem);overflow-y:auto;padding:.35rem 1.25rem 1.4rem}.more-links{display:grid;gap:.35rem}.menu-group{margin-top:1rem}.menu-group h2{margin:0;padding:.55rem .7rem;background:var(--color-surface-muted);color:var(--color-foreground);font-size:.78rem;font-weight:850;letter-spacing:.1em;text-transform:uppercase}.menu-group>div{display:grid}.more-links a{display:flex;align-items:center;justify-content:space-between;gap:1rem;min-height:3.6rem;padding:.35rem .7rem;border-bottom:1px solid var(--color-border);color:var(--color-primary);font-size:.92rem;font-weight:740;text-decoration:none}.more-links a span:last-child{color:var(--color-accent);font-size:1rem}.more-links a[aria-current='page']{color:var(--color-primary);background:var(--color-background)}.sheet-actions{display:flex;gap:.5rem;padding-top:1rem}.sheet-actions button{width:100%;min-height:3.2rem;padding:.65rem;border:1px solid var(--color-primary);background:transparent;color:var(--color-primary);font:inherit;font-size:.82rem;font-weight:780;cursor:pointer}.sheet-actions .mobile-sign-out{border-color:var(--color-primary);background:var(--color-primary);color:var(--color-on-primary)}
	...
	@media(max-width:760px){
		...
		.menu-toggle{display:inline-flex;min-height:2.65rem;align-items:center;gap:.5rem;margin-left:auto;padding:0 .85rem;border:1px solid var(--color-border-strong)}.portal-menu{display:none;width:100%;align-items:stretch;flex-direction:column;padding:1rem 0 .35rem}.portal-menu.open{display:flex}.portal-links{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:.35rem;overflow:visible}.portal-links a{min-height:3rem;padding:.4rem .75rem;white-space:normal;border:1px solid var(--color-border-strong)}.portal-actions{width:100%;margin:0;padding-top:.75rem;border-top:1px solid var(--color-border-strong)}.portal-actions .sign-out{margin-left:auto}
		.mobile-nav{position:fixed;z-index:55;left:0;right:0;bottom:0;display:grid;grid-template-columns:repeat(var(--nav-count,4),minmax(0,1fr));min-height:4.7rem;padding:0 .25rem max(.35rem,env(safe-area-inset-bottom));border-top:1px solid var(--color-border);background:rgba(250,248,242,.98);box-shadow:0 -8px 28px rgba(23,24,27,.09);backdrop-filter:none}
		.mobile-nav a{position:relative;display:flex;min-width:0;min-height:4.35rem;flex-direction:column;align-items:center;justify-content:center;gap:.32rem;padding:.48rem .15rem .25rem;border:0;background:transparent;color:var(--color-foreground);font:inherit;font-size:.78rem;font-weight:760;line-height:1.1;text-align:center;text-decoration:none;cursor:pointer;transition:color .16s ease,background-color .18s ease}
		.mobile-nav a::after{content:'';position:absolute;top:0;left:22%;right:22%;height:3px;background:transparent}
		.mobile-nav a[aria-current='page']{background:var(--color-background);color:var(--color-primary)}.mobile-nav a[aria-current='page']::after{background:var(--color-primary)}
		...
		.more-sheet{z-index:71;top:auto;left:0;right:0;bottom:0;width:auto;margin:0;max-height:min(82vh,46rem);border-left:0;border-top:4px solid var(--color-primary);box-shadow:0 -24px 70px rgba(23,24,27,.28);animation:sheet-in .2s ease-out}
		.more-sheet header{display:flex;align-items:center;justify-content:space-between;padding:1.05rem 1.15rem;border-bottom:1px solid var(--color-border)}.more-sheet header div{display:flex;flex-direction:column;gap:.14rem}.more-sheet header span{color:var(--color-primary);font-size:.68rem;font-weight:850;letter-spacing:.14em;text-transform:uppercase}.more-sheet header strong{font-family:var(--font-serif);font-size:1.35rem}.more-sheet header button{display:grid;place-items:center;width:2.75rem;height:2.75rem;border:1px solid var(--color-border);background:transparent;color:var(--color-primary);font-size:1.6rem;cursor:pointer}
		...
		.sheet-actions{display:flex;gap:.5rem;padding-top:1rem}.sheet-actions button{flex:1;min-height:3.2rem;padding:.65rem;border:1px solid var(--color-primary);background:transparent;color:var(--color-primary);font:inherit;font-size:.82rem;font-weight:780;cursor:pointer}.sheet-actions .mobile-sign-out{border-color:var(--color-primary);background:var(--color-primary);color:var(--color-on-primary)}
	}
	@media(max-width:390px){.account-label{display:none}.mobile-header-menu{margin-left:auto}}
