...
{#if hasMobileBar}
	<div class="mobile-nav" role="navigation" aria-label={`${label} main pages`}>
...
<style>
  .signout-error{position:relative;z-index:58;margin:0;padding:1rem;background:#fff3e0;color:#603f16;border-bottom:1px solid #c5a174;line-height:1.6}.signout-error p{margin:0 0 .5rem}.signout-error button{padding:.6rem 1rem;border:1px solid currentColor;background:transparent;color:inherit}.more-sheet:not([open]){display:none}.more-sheet{margin:0 0 0 auto;max-width:none;max-height:none;padding:0;color:var(--color-foreground)}.more-sheet::backdrop{background:rgb(23 24 27 / .48)}
	...
	.brand{display:inline-flex;align-items:center;gap:.65rem;color:#fff;font-family:var(--font-serif);font-weight:650;font-size:1.15rem;text-decoration:none;white-space:nowrap}.brand span{display:grid;place-items:center;width:2rem;height:2rem;background:#2738d6;color:#fff}
	...
	.portal-actions{display:flex;align-items:center;gap:.35rem;margin-left:auto}.portal-actions button,.menu-toggle,.mobile-header-menu{border:0;background:transparent;color:#c7c6c1;font:inherit;font-size:.82rem;font-weight:680;cursor:pointer;white-space:nowrap}.portal-actions .search,.portal-actions .desktop-header-menu{display:inline-flex;align-items:center;gap:.4rem;padding:.45rem .7rem;border:1px solid #4b4c51}.portal-actions .desktop-header-menu.active{border-color:#7e87ef;color:#fff}.desktop-header-menu span{color:#ff8b70;font-size:1rem}.search kbd{font-family:inherit;font-size:.7rem;color:#b8b9bc}.menu-toggle,.mobile-header-menu{display:none}.menu-toggle span,.mobile-header-menu span{font-size:1.2rem;color:#ff6848}
	...
	@media(max-width:760px){
		...
		.more-sheet header{display:flex;align-items:center;justify-content:space-between;padding:1.05rem 1.15rem;border-bottom:1px solid #d7d2c8}.more-sheet header div{display:flex;flex-direction:column;gap:.14rem}.more-sheet header span{color:#2738d6;font-size:.68rem;font-weight:850;letter-spacing:.14em;text-transform:uppercase}.more-sheet header strong{font-family:var(--font-serif);font-size:1.35rem}.more-sheet header button{display:grid;place-items:center;width:2.75rem;height:2.75rem;border:1px solid #b8b4ab;background:transparent;color:#17181b;font-size:1.6rem;cursor:pointer}
