...
<style>
	.share-actions{display:flex;flex-wrap:wrap;align-items:center;gap:.65rem;margin:.8rem 0}.share-actions a,.share-actions button{display:inline-flex;align-items:center;justify-content:center;min-height:2.75rem;padding:.55rem .8rem;border:1px solid var(--color-foreground);background:var(--color-surface);color:var(--color-foreground);font:inherit;font-weight:750;text-decoration:none}.share-actions a{border-color:var(--color-positive);background:var(--color-positive);color:var(--color-on-primary)}.share-actions small{flex-basis:100%;color:var(--color-muted)}.compact{margin:.35rem 0}.compact a,.compact button{min-height:2.5rem;font-size:.82rem}
</style>
