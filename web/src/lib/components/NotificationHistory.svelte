...
{/if}</main>
<style>.messages{max-width:64rem}.messages header{max-width:52rem}.messages h1{max-width:15ch;font-family:var(--font-serif);font-size:clamp(3rem,6vw,5.2rem);font-weight:500;line-height:.94;letter-spacing:-.055em}.summary{display:grid;grid-template-columns:repeat(3,1fr);margin:2rem 0;border-top:1px solid var(--color-border);border-left:1px solid var(--color-border)}.summary article{display:grid;gap:.4rem;padding:1rem;border-right:1px solid var(--color-border);border-bottom:1px solid var(--color-border);background:var(--color-surface)}.summary span{color:var(--color-muted);font-size:.75rem}.summary strong{font-family:var(--font-serif);font-size:2rem;font-weight:500}.summary article.danger{border-top:4px solid var(--color-overdue)}.toolbar{display:flex;align-items:center;gap:.4rem;flex-wrap:wrap;margin:1.5rem 0;padding:.6rem;background:var(--color-primary)}.toolbar button{min-height:2.6rem;padding:.55rem .8rem;border:1px solid rgb(255 255 255 / .28);background:transparent;color:var(--color-on-primary);font:inherit;font-size:.75rem;font-weight:750}.toolbar button.active{border-color:var(--color-accent);background:var(--color-accent);color:var(--color-on-primary)}.toolbar a{margin-left:auto;color:var(--color-on-primary);font-size:.76rem;font-weight:750}.list{display:grid;gap:.75rem;margin-top:2rem}.list article{padding:1rem 1.1rem;border:1px solid var(--color-border);border-left:4px solid var(--color-primary);background:var(--color-surface)}.list article.failed-card{border-left-color:var(--color-overdue)}.message-head{display:flex;justify-content:space-between;gap:1rem}.message-head>div{display:grid;gap:.25rem}.channel{color:var(--color-primary);font-size:.65rem;font-weight:850;letter-spacing:.08em;text-transform:uppercase}.state{font-size:.75rem;font-weight:750}.body{margin:.75rem 0;color:var(--color-foreground);line-height:1.6}.meta{display:flex;justify-content:space-between;gap:1rem;color:var(--color-muted);font-size:.72rem}.failed,.error{color:var(--color-destructive)}.failed{margin:.75rem 0 0;padding:.7rem;background:var(--color-background)}.empty-state{padding:3rem;background:var(--color-primary);color:var(--color-on-primary)}.empty-state p{color:var(--color-surface-muted)}.explain{margin-top:2rem;padding:1rem;border-left:4px solid var(--color-positive);background:var(--color-background)}.explain p{margin:.4rem 0;color:var(--color-foreground);line-height:1.6}@media(max-width:650px){.summary{grid-template-columns:1fr}.toolbar{align-items:stretch}.toolbar button{flex:1}.toolbar a{width:100%;margin:0;padding:.6rem}.message-head,.meta{align-items:flex-start;flex-direction:column;gap:.45rem}}</style>
