...
<style>section{margin-block:1.5rem}article,form{padding:1rem;border:1px solid var(--border,#ddd);border-radius:.7rem;margin-block:1rem}form,fieldset,label{display:grid;gap:.6rem}input,button,select,textarea{font:inherit;padding:.65rem}p{line-height:1.5}</style>
