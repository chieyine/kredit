...
{/if}
<style>dialog{width:min(34rem,calc(100vw - 2rem));padding:0;border:1px solid var(--color-border);border-radius:0;background:var(--color-surface);color:var(--color-foreground);box-shadow:var(--shadow-md)}dialog::backdrop{background:rgb(23 24 27 / .68);backdrop-filter:blur(3px)}form{display:grid;gap:1rem;padding:clamp(1.25rem,4vw,2rem)}h2{margin:0;font-family:var(--font-serif);font-size:1.65rem;font-weight:500;letter-spacing:-.03em}.dialog-mark{display:grid;place-items:center;width:2.5rem;height:2.5rem;border-radius:0;background:var(--color-background);color:var(--color-warning);font-weight:900}label{display:grid;gap:.4rem;font-weight:750}textarea{box-sizing:border-box;width:100%;padding:.75rem;border:1px solid var(--color-border);border-radius:0;background:var(--color-surface);font:inherit;resize:vertical}aside{padding:1rem;border:1px solid var(--color-border);border-radius:0;background:var(--color-surface-muted)}aside p{margin:.4rem 0 0;color:var(--color-muted);line-height:1.5}.actions{display:flex;justify-content:flex-end;gap:.7rem}.actions button{padding:.65rem 1rem;border:1px solid var(--color-border);border-radius:0;background:var(--color-surface);color:var(--color-foreground);font:inherit;font-weight:750;cursor:pointer}.actions .primary{border:0;background:var(--color-primary);color:var(--color-on-primary)}</style>
