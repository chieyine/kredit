...
<style>.sale-progress{border:1px solid var(--color-border,#d8e1df);border-left:4px solid var(--color-primary,#303caa);border-radius:.75rem;padding:1.25rem;margin:1rem 0;background:var(--color-surface,#fff)}a{display:inline-flex;align-items:center;min-height:44px;padding-block:.5rem}h2{margin:.35rem 0;font-size:1.3rem}p{line-height:1.6}summary{cursor:pointer;padding:.8rem 0}ol{padding-left:1.3rem}li{padding:.45rem 0}li span{display:block;color:var(--color-muted,#626977);font-size:.9rem}</style>
